        ...
        <div className="testing-results">
          {isLoading ? (
              ...
              {itemType === 'template' ? (
                ...
                <>
                  <div className="chain-results">
                    {testResult.intermediate_results.map((step, index) => (
                      <div key={index} className="chain-step">
                        <div className="step-header">
                          <h4>Step {step.step}: {step.template_title}</h4>
                          <div className="step-time">{step.execution_time.toFixed(2)}s</div>
                        </div>
                        ...
                        <div className="step-content">
                          <div className="step-prompt">
                            <div className="content-header">
                              ...
                              <button 
                                className="copy-button"
                                onClick={() => handleCopyToClipboard(step.prompt)}
                                title="Copy to clipboard"
                              >
                                <FaClipboard />
                              </button>
                          ...
                          <div className="step-response">
                            <div className="content-header">
                              ...
                              <button 
                                className="copy-button"
                                onClick={() => handleCopyToClipboard(step.response)}
                                title="Copy to clipboard"
                              >
                                <FaClipboard />
                              </button>
                  ...
                  <div className="result-section">
                    <div className="section-header">
                      ...
                      <button 
                        className="copy-button"
                        onClick={() => handleCopyToClipboard(testResult.final_result)}
                        title="Copy to clipboard"
                      >
                        <FaClipboard />
                      </button>
                    ...
                    <div className="final-result-display">
                      <pre>{testResult.final_result}</pre>
                    </div>
                  </div>
                </>
              )}
            ...
            <div className="no-results">
              ...
              <h3>Test Your {itemType === 'template' ? 'Prompt Template' : 'Prompt Chain'}</h3>
              <p>Configure the settings and run a test to see results.</p>
              <ul>
                <li>Select an AI model</li>
                <li>Adjust parameters like temperature</li>
                <li>Fill in variable values</li>
                <li>Click "Run Test" to see the results</li>
              </ul>
            </div>
          )}
        </div>
